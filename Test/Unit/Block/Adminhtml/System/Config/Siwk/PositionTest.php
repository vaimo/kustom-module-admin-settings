...
use Klarna\AdminSettings\Block\Adminhtml\System\Config\Siwk\Position;
use Klarna\Base\Test\Unit\Mock\TestCase;

/**
 * @coversDefaultClass \Klarna\AdminSettings\Block\Adminhtml\System\Config\Siwk\Position
 */
class PositionTest extends TestCase
{
    ...
    {
        $this->position->setData('config_data', ['klarna/siwk/placement' => 'cart-page,checkout-page']);
        $this->position->calculateAndSetCheckedFields();

        static::assertTrue($this->position->isChecked('cart-page'));
        static::assertTrue($this->position->isChecked('checkout-page'));
    }

    public function testIsCheckedEmptyCheckedListImpliesReturningFalse(): void
    {
        static::assertFalse($this->position->isChecked('cart-page'));
    }
    ...
    {
        $this->position->setData('config_data', ['klarna/siwk/placement' => 'cart-page']);
        $this->position->calculateAndSetCheckedFields();
